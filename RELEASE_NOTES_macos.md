...
First macOS build of the stutter filter, contributed by @filipemelo. It is a native menu-bar app that applies the same debounce algorithm as the Windows version, using CGEventTap. Requires macOS 13 or later.
